...
parser.add_argument('--type_dir', type=str, default='./data/json/test_tracks_type.json', help='input directory of type prediction file')
parser.add_argument('--color_dir', type=str, default='./data/json/test_tracks_color.json', help='input directory of color prediction file')
