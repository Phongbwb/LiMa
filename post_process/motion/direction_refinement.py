from post_process.motion.TurnDetector import *
from post_process.motion.StopDetector import *
import json

full_uuid = json.load(open("./data/json/test-tracks.json"))
cur_result = json.load(open("./data/json/test_queries_direction.json"))
...
def run_direction(cur_result):
    ...
    json.dump(
        cur_result,
        open("./data/json/test-tracks-direction-refinement.json", "w"),
        indent=4,
    )
